...
// Had to the user the below from StackOverflow to get the AndSpecification working with EF Core 
...
internal sealed class AndSpecification<T> : Specification<T>
{
    ...
    public override Expression<Func<T, bool>> ToExpression()
    {
        ...
        var rewrittedRight = visitor.Visit(rightExpression.Body);

        BinaryExpression andExpression = Expression.AndAlso(leftExpression.Body, rewrittedRight);
