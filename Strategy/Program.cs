...
static IInvoiceStrategy GetInvoiceStrategyFor(int option)
{
    switch (option)
    {
...
static IShippingStrategy GetShippingStrategyFor(int provider)
{
    switch (provider)
    {
...
static ISalesTaxStrategy GetSalesTaxStrategyFor(string origin)
{
